...
public class SpiralStrategyPlayer
{
	...
	//private static final Logger log=Logger.getLogger(SpiralStrategyPlayer.class);
	
	public SpiralStrategyPlayer(int playerId, int pathId)
	{
